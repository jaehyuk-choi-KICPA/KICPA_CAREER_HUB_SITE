...
_DEFAULTS: dict = {
    ...
    "dashboard": {
        ...
        "industry_exclude": [
            ...
            # 목적 이탈 유형(실측 186건 중 11건) — 숫자로 드러나는 '기업의 사건'이 아닌 것들
            "노조", "임단협", "파업", "성과보상", "하투",          # 노사
            "리그테이블", "순위표",                                  # 매체 자체 집계
            "무역수지", "지역경제",                                  # 지역·거시 지표
            "가성비", "맛집", "신메뉴", "먹거리",                     # 소비 트렌드
        ...
        "industry_companies": {
            ...
            "DB하이텍":                 {"industries": ["반도체·전자"], "aliases": []},
            "원익IPS":                 {"industries": ["반도체·전자"], "aliases": []},
            "리노공업":                  {"industries": ["반도체·전자"], "aliases": []},
            "이오테크닉스":                {"industries": ["반도체·전자"], "aliases": []},
            "주성엔지니어링":               {"industries": ["반도체·전자"], "aliases": []},
            "솔브레인":                  {"industries": ["반도체·전자"], "aliases": []},
            "동진쎄미켐":                 {"industries": ["반도체·전자"], "aliases": []},
            "SKC":                   {"industries": ["반도체·전자"], "aliases": [], "strict": True},
            "심텍":                    {"industries": ["반도체·전자"], "aliases": [], "strict": True},
            "LX세미콘":                 {"industries": ["반도체·전자"], "aliases": []},
            "피에스케이":                 {"industries": ["반도체·전자"], "aliases": []},
            "파크시스템스":                {"industries": ["반도체·전자"], "aliases": []},
            "서울반도체":                 {"industries": ["반도체·전자"], "aliases": []},
            "에스에프에이":                {"industries": ["반도체·전자"], "aliases": []},
            "대덕전자":                  {"industries": ["반도체·전자"], "aliases": []},
            ...
            "한온시스템":                 {"industries": ["자동차·모빌리티"], "aliases": []},
            "HL만도":                  {"industries": ["자동차·모빌리티"], "aliases": ["만도"]},
            "현대위아":                  {"industries": ["자동차·모빌리티"], "aliases": []},
            "에스엘":                   {"industries": ["자동차·모빌리티"], "aliases": [], "strict": True},
            "성우하이텍":                 {"industries": ["자동차·모빌리티"], "aliases": []},
            "금호타이어":                 {"industries": ["자동차·모빌리티"], "aliases": []},
            "넥센타이어":                 {"industries": ["자동차·모빌리티"], "aliases": []},
            "한국타이어앤테크놀로지":           {"industries": ["자동차·모빌리티"], "aliases": ["한국타이어"]},
            "에코프로비엠":                {"industries": ["자동차·모빌리티"], "aliases": []},
            "에코프로":                  {"industries": ["자동차·모빌리티"], "aliases": [], "strict": True},
            "엘앤에프":                  {"industries": ["자동차·모빌리티"], "aliases": []},
            "SK아이이테크놀로지":            {"industries": ["자동차·모빌리티"], "aliases": ["SKIET"]},
            "현대오토에버":                {"industries": ["자동차·모빌리티"], "aliases": []},
            "현대글로비스":                {"industries": ["자동차·모빌리티"], "aliases": []},
            ...
            "HD현대":                  {"industries": ["조선·방산·기계"], "aliases": [], "strict": True},
            "HD현대미포":                {"industries": ["조선·방산·기계"], "aliases": []},
            "HD현대일렉트릭":              {"industries": ["조선·방산·기계"], "aliases": []},
            "HD현대인프라코어":             {"industries": ["조선·방산·기계"], "aliases": []},
            "한화시스템":                 {"industries": ["조선·방산·기계"], "aliases": []},
            "LIG넥스원":                {"industries": ["조선·방산·기계"], "aliases": []},
            "현대로템":                  {"industries": ["조선·방산·기계"], "aliases": []},
            "한국항공우주":                {"industries": ["조선·방산·기계"], "aliases": ["KAI"]},
            "두산에너빌리티":               {"industries": ["조선·방산·기계"], "aliases": []},
            "두산밥캣":                  {"industries": ["조선·방산·기계"], "aliases": []},
            "효성중공업":                 {"industries": ["조선·방산·기계"], "aliases": []},
            "팬오션":                   {"industries": ["조선·방산·기계"], "aliases": []},
            "대한해운":                  {"industries": ["조선·방산·기계"], "aliases": []},
            "HJ중공업":                 {"industries": ["조선·방산·기계"], "aliases": []},
            "STX엔진":                 {"industries": ["조선·방산·기계"], "aliases": []},
            ...
            "HDC현대산업개발":             {"industries": ["건설·부동산"], "aliases": ["HDC현산"]},
            "태영건설":                  {"industries": ["건설·부동산"], "aliases": []},
            "코오롱글로벌":                {"industries": ["건설·부동산"], "aliases": []},
            "금호건설":                  {"industries": ["건설·부동산"], "aliases": []},
            "계룡건설":                  {"industries": ["건설·부동산"], "aliases": []},
            "아이에스동서":                {"industries": ["건설·부동산"], "aliases": []},
            "한신공영":                  {"industries": ["건설·부동산"], "aliases": []},
            "두산건설":                  {"industries": ["건설·부동산"], "aliases": []},
            "KCC건설":                 {"industries": ["건설·부동산"], "aliases": []},
            "DL건설":                  {"industries": ["건설·부동산"], "aliases": []},
            "신세계건설":                 {"industries": ["건설·부동산"], "aliases": []},
            ...
            "한화솔루션":                 {"industries": ["에너지·화학"], "aliases": []},
            "대한유화":                  {"industries": ["에너지·화학"], "aliases": []},
            "효성티앤씨":                 {"industries": ["에너지·화학"], "aliases": []},
            "효성첨단소재":                {"industries": ["에너지·화학"], "aliases": []},
            "코오롱인더스트리":              {"industries": ["에너지·화학"], "aliases": ["코오롱인더"]},
            "태광산업":                  {"industries": ["에너지·화학"], "aliases": []},
            "KCC":                   {"industries": ["에너지·화학"], "aliases": [], "strict": True},
            "한솔케미칼":                 {"industries": ["에너지·화학"], "aliases": []},
            "한국가스공사":                {"industries": ["에너지·화학"], "aliases": ["가스공사"]},
            "SK가스":                  {"industries": ["에너지·화학"], "aliases": []},
            "E1":                    {"industries": ["에너지·화학"], "aliases": [], "strict": True},
            "두산퓨얼셀":                 {"industries": ["에너지·화학"], "aliases": []},
            "씨에스윈드":                 {"industries": ["에너지·화학"], "aliases": []},
            "포스코홀딩스":                {"industries": ["철강·소재"], "aliases": ["포스코"], "dart": "POSCO홀딩스"},
            "현대제철":                  {"industries": ["철강·소재"], "aliases": []},
            "고려아연":                  {"industries": ["철강·소재"], "aliases": []},
            "포스코퓨처엠":                {"industries": ["철강·소재"], "aliases": []},
            "동국제강":                  {"industries": ["철강·소재"], "aliases": []},
            "포스코인터내셔널":              {"industries": ["철강·소재"], "aliases": []},
            "세아베스틸지주":               {"industries": ["철강·소재"], "aliases": ["세아베스틸"]},
            "세아제강":                  {"industries": ["철강·소재"], "aliases": []},
            "KG스틸":                  {"industries": ["철강·소재"], "aliases": []},
            "풍산":                    {"industries": ["철강·소재"], "aliases": [], "strict": True},
            "영풍":                    {"industries": ["철강·소재"], "aliases": [], "strict": True},
            "한일시멘트":                 {"industries": ["철강·소재"], "aliases": []},
            "아세아시멘트":                {"industries": ["철강·소재"], "aliases": []},
            "대한제강":                  {"industries": ["철강·소재"], "aliases": []},
            "한국철강":                  {"industries": ["철강·소재"], "aliases": []},
            ...
            "대웅제약":                  {"industries": ["제약·바이오"], "aliases": []},
            "종근당":                   {"industries": ["제약·바이오"], "aliases": []},
            "GC녹십자":                 {"industries": ["제약·바이오"], "aliases": ["녹십자"]},
            "JW중외제약":                {"industries": ["제약·바이오"], "aliases": ["중외제약"]},
            "광동제약":                  {"industries": ["제약·바이오"], "aliases": []},
            "동아에스티":                 {"industries": ["제약·바이오"], "aliases": []},
            "보령":                    {"industries": ["제약·바이오"], "aliases": [], "strict": True},
            "일동제약":                  {"industries": ["제약·바이오"], "aliases": []},
            "대원제약":                  {"industries": ["제약·바이오"], "aliases": []},
            "환인제약":                  {"industries": ["제약·바이오"], "aliases": []},
            "휴젤":                    {"industries": ["제약·바이오"], "aliases": [], "strict": True},
            "클래시스":                  {"industries": ["제약·바이오"], "aliases": []},
            "파마리서치":                 {"industries": ["제약·바이오"], "aliases": []},
            "알테오젠":                  {"industries": ["제약·바이오"], "aliases": []},
            "리가켐바이오":                {"industries": ["제약·바이오"], "aliases": []},
            "에이비엘바이오":               {"industries": ["제약·바이오"], "aliases": []},
            "SK바이오사이언스":             {"industries": ["제약·바이오"], "aliases": []},
            "코오롱티슈진":                {"industries": ["제약·바이오"], "aliases": []},
            "HLB":                   {"industries": ["제약·바이오"], "aliases": [], "strict": True},
            "셀트리온제약":                {"industries": ["제약·바이오"], "aliases": []},
            ...
            "BGF리테일":                {"industries": ["유통·소비재"], "aliases": ["CU"]},
            "GS리테일":                 {"industries": ["유통·소비재"], "aliases": []},
            "신세계":                   {"industries": ["유통·소비재"], "aliases": [], "strict": True},
            "현대백화점":                 {"industries": ["유통·소비재"], "aliases": []},
            "롯데웰푸드":                 {"industries": ["유통·소비재"], "aliases": []},
            "오뚜기":                   {"industries": ["유통·소비재"], "aliases": []},
            "빙그레":                   {"industries": ["유통·소비재"], "aliases": []},
            "매일유업":                  {"industries": ["유통·소비재"], "aliases": []},
            "남양유업":                  {"industries": ["유통·소비재"], "aliases": []},
            "LG생활건강":                {"industries": ["유통·소비재"], "aliases": ["LG생건"]},
            "한국콜마":                  {"industries": ["유통·소비재"], "aliases": []},
            "코스맥스":                  {"industries": ["유통·소비재"], "aliases": []},
            "동원F&B":                 {"industries": ["유통·소비재"], "aliases": []},
            "하이트진로":                 {"industries": ["유통·소비재"], "aliases": []},
            "롯데칠성음료":                {"industries": ["유통·소비재"], "aliases": ["롯데칠성"]},
            ...
            "메리츠금융지주":               {"industries": ["금융·보험"], "aliases": ["메리츠금융"]},
            "DB손해보험":                {"industries": ["금융·보험"], "aliases": ["DB손보"]},
            "현대해상":                  {"industries": ["금융·보험"], "aliases": []},
            "한화생명":                  {"industries": ["금융·보험"], "aliases": []},
            "카카오뱅크":                 {"industries": ["금융·보험"], "aliases": []},
            "카카오페이":                 {"industries": ["금융·보험"], "aliases": []},
            "미래에셋증권":                {"industries": ["금융·보험"], "aliases": []},
            "NH투자증권":                {"industries": ["금융·보험"], "aliases": []},
            "삼성증권":                  {"industries": ["금융·보험"], "aliases": []},
            "키움증권":                  {"industries": ["금융·보험"], "aliases": []},
            "한국금융지주":                {"industries": ["금융·보험"], "aliases": ["한국투자금융지주"]},
            "기업은행":                  {"industries": ["금융·보험"], "aliases": []},
            "BNK금융지주":               {"industries": ["금융·보험"], "aliases": ["BNK금융"]},
            "JB금융지주":                {"industries": ["금융·보험"], "aliases": ["JB금융"]},
            ...
            "쿠팡":                    {"industries": ["IT·플랫폼·게임"], "aliases": []},
            "삼성SDS":                 {"industries": ["IT·플랫폼·게임"], "aliases": []},
            "NHN":                   {"industries": ["IT·플랫폼·게임"], "aliases": [], "strict": True},
            "더존비즈온":                 {"industries": ["IT·플랫폼·게임"], "aliases": []},
            "위메이드":                  {"industries": ["IT·플랫폼·게임"], "aliases": []},
            "펄어비스":                  {"industries": ["IT·플랫폼·게임"], "aliases": []},
            "컴투스":                   {"industries": ["IT·플랫폼·게임"], "aliases": []},
            "데브시스터즈":                {"industries": ["IT·플랫폼·게임"], "aliases": []},
            "시프트업":                  {"industries": ["IT·플랫폼·게임"], "aliases": []},
            "웹젠":                    {"industries": ["IT·플랫폼·게임"], "aliases": [], "strict": True},
            "안랩":                    {"industries": ["IT·플랫폼·게임"], "aliases": [], "strict": True},
            "한글과컴퓨터":                {"industries": ["IT·플랫폼·게임"], "aliases": ["한컴"]},
            "SK텔레콤":                 {"industries": ["통신·미디어·엔터"], "aliases": ["SKT"]},
            "KT":                    {"industries": ["통신·미디어·엔터"], "aliases": [], "dart": "케이티", "strict": True},
            ...
            "SM엔터테인먼트":              {"industries": ["통신·미디어·엔터"], "aliases": ["에스엠"]},
            "JYP Ent.":              {"industries": ["통신·미디어·엔터"], "aliases": ["JYP"]},
            "YG엔터테인먼트":              {"industries": ["통신·미디어·엔터"], "aliases": []},
            "스튜디오드래곤":               {"industries": ["통신·미디어·엔터"], "aliases": []},
            "콘텐트리중앙":                {"industries": ["통신·미디어·엔터"], "aliases": []},
            "제일기획":                  {"industries": ["통신·미디어·엔터"], "aliases": []},
            "이노션":                   {"industries": ["통신·미디어·엔터"], "aliases": []},
            "나스미디어":                 {"industries": ["통신·미디어·엔터"], "aliases": []},
            "디앤씨미디어":                {"industries": ["통신·미디어·엔터"], "aliases": []},
            "SBS":                   {"industries": ["통신·미디어·엔터"], "aliases": [], "strict": True},
            "스카이라이프":                {"industries": ["통신·미디어·엔터"], "aliases": []},
        },
