...
_DEFAULTS: dict = {
    ...
    "dashboard": {
        ...
        # 감사인·감사의견·KAM은 사업보고서 기준이라 실질적으로 연 1회 바뀐다. 주 1회로 뒀다가
        # 매일로 낮춤 — 한도(일 2만 건)에 비해 호출이 120개뿐이라 부담이 없고, 키·연동 이상을
        # 일주일 뒤가 아니라 하루 안에 알아챌 수 있다(관측성이 비용보다 값지다).
        "companies_min_interval_minutes": 1440,
